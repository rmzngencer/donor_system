    ...
    <section id="menu">
      ...
      <form action="userlog.php" method="POST" >
        <div class="imgcontainer">
          <img src="img/246-2461806_person-icon-png-woman-man-woman-icon-png.png" alt="Avatar" class="avatar">
        </div>
        ...
        <input type="checkbox" checked="checked" name="remember"> Remember me
          ...
          <br><br>
          <a href="personnellogin.php" id="have">Admin Login</a>
          <br>
          <br>
          <a href="form.php" id="have">Don't have an account yet?</a>
